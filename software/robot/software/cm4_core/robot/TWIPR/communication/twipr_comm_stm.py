...
import robot.TWIPR.parameters as parameters
from cm4_core import utils

from cm4_core.communication.serial.serial_device import Serial_Device
...
class TWIPR_Communication_STM32:
    ...
    # === INIT =========================================================================================================
    def __init__(self):
        self.device = Serial_Device(device=parameters.TWIPR_PARAMS_BOARD_STM32_UART,
