...
firmware/drive/%.o firmware/drive/%.su: ../firmware/drive/%.cpp firmware/drive/subdir.mk
...
clean-firmware-2f-drive:
	-$(RM) ./firmware/drive/twipr_drive.d ./firmware/drive/twipr_drive.o ./firmware/drive/twipr_drive.su
