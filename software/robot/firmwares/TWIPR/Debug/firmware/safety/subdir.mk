...
firmware/safety/%.o firmware/safety/%.su: ../firmware/safety/%.cpp firmware/safety/subdir.mk
...
clean-firmware-2f-safety:
	-$(RM) ./firmware/safety/twipr_safety.d ./firmware/safety/twipr_safety.o ./firmware/safety/twipr_safety.su
