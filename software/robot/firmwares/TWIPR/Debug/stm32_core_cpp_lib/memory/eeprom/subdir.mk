...
CPP_SRCS += \
C:/work_dir/projects/testbed/software/robots/software_board/libraries/general/stm32_core_cpp_lib/memory/eeprom/core_memory_eeprom.cpp 
...
stm32_core_cpp_lib/memory/eeprom/core_memory_eeprom.o: C:/work_dir/projects/testbed/software/robots/software_board/libraries/general/stm32_core_cpp_lib/memory/eeprom/core_memory_eeprom.cpp stm32_core_cpp_lib/memory/eeprom/subdir.mk
...
clean-stm32_core_cpp_lib-2f-memory-2f-eeprom:
	-$(RM) ./stm32_core_cpp_lib/memory/eeprom/core_memory_eeprom.d ./stm32_core_cpp_lib/memory/eeprom/core_memory_eeprom.o ./stm32_core_cpp_lib/memory/eeprom/core_memory_eeprom.su
